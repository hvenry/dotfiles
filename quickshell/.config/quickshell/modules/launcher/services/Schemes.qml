...
Searcher {
    ...
    Component.onCompleted: {
        // Set empty model since CLI is disabled
        schemes.model = [];
    }
    ...
    component Scheme: QtObject {
        ...
        function onClicked(list: AppList): void {
            ...
            // Disabled: requires caelestia CLI
            // To change scheme, edit ~/.local/state/caelestia/scheme.json manually
            console.log("Scheme switching disabled - edit scheme.json manually");
        }
    }
}
